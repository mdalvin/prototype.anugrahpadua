  ...
  return (
    ...
    <div className="h-fit lg:h-fit w-screen bg-white text-left px-5 py-10 lg:px-40 lg:py-20 grid align-top bg-opacity-90">
      <div className="mb-5 lg:mb-10 w-full text-end">
        ...
        <p className="text-blue text-sm lg:text-base font-normal text-center mt-5 lg:mt-10">
      ...
      <div className="flex lg:justify-center justify-between w-full h-fit text-blue py-2">
        <div className="grid h-fit w-[33%] text-center items-center justify-center">
          <div className="w-20 h-20 grid rounded-full mb-1 place-self-center items-center justify-center">
      ...
      <div className="flex justify-left lg:justify-center w-full h-fit text-blue py-2 mt-4 lg:mb-10">
      ...
      <div className="py-6 lg:py-10 w-full text-end">
        <p className="text-blue text-sm lg:text-base font-normal text-center">
      ...
      <div className="flex lg:justify-center justify-between w-full h-fit text-blue py-2">
        <div className="grid w-[33%] h-fit text-center items-center justify-center">
          <div className="w-20 h-20 grid rounded-full bg-red mb-1 place-self-center items-center justify-center">
            <div className="bg-pricing h-20 w-20 bg-cover bg-no-repeat bg-opacity-20 rounded-full" />
          </div>{" "}
          <p className="font-semibold uppercase text-[10px] lg:text-base">
            <Text tid={"reason_1"} />
          </p>
        </div>
        <div className="grid w-[33%] h-fit text-center items-center justify-center">
